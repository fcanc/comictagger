#!/usr/bin/python
"""Organize comics in a folder tree

Search for comic files with tags and move those files according to their
metadata, organizing in a tree by Publisher/Series (Volume).
"""

#This script is based on make_links.py by Anthony Beville
#
# Copyright 2012-2015 Fabio Cancedda, Anthony Beville
#
